...
const fullStackProjects = [
  ...
  },
  {
    ...
    description: "A full-featured social media platform with real-time messaging, post sharing, user profiles, and notifications. Built with React for the frontend and Firebase for backend services.",
    techStack: ["React", "Firebase", "Cloud Functions", "Firestore", "Redux", "Styled Components", "WebSockets"],
  ...
  },
  {
    ...
    description: "A comprehensive project management tool with task tracking, team collaboration, file sharing, and analytics. Implements drag-and-drop kanban boards and real-time updates.",
    techStack: ["Vue.js", "Django", "PostgreSQL", "WebSockets", "Docker", "Redis", "Celery", "Chart.js"],
    githubUrl: "https://github.com/yourusername/project-management",
    liveUrl: "https://projectmanagement.example.com",
    images: [
  ...
  },
  {
    ...
    description: "An educational platform with course creation tools, student enrollment, progress tracking, quiz system, and certificate generation. Supports video lectures and interactive assignments.",
    techStack: ["React", "Node.js", "MongoDB", "GraphQL", "Apollo", "AWS S3", "Stripe", "TypeScript"],
...
const FullStackProject = () => {
  ...
  const prevProject = () => {
    setCurrentProjectIndex((prev) => (prev - 1 + fullStackProjects.length) % fullStackProjects.length);
    setCurrentImageIndex(0); // Reset image index when changing projects
  };
      ...
      <div className="section-container">
        <div className="text-center mb-12 max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg">
            Explore my comprehensive full-stack development projects
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="relative aspect-video bg-accent rounded-xl overflow-hidden shadow-lg">
            <div
              ...
              style={{ backgroundImage: `url(${currentProject.images[currentImageIndex]})` }}
            />
          ...
          <Card className="border bg-card p-8 h-full shadow-sm">
            <h3 className="text-2xl font-medium mb-4">{currentProject.title}</h3>
